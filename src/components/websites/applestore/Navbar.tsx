const Navbar = () => {
  ...
  return (
    <div className="max-sm:mx-5 max-lg:mx-10">
      <ul className="font-light flex text-xs text-[#000c] px-5 max-lg:px-0 tracking-wider justify-between items-center max-w-5xl mx-auto">
        <li>
          <svg
            height="44"
            viewBox="0 0 14 44"
        ...
        {/* <li>
          <svg
            ...
            stroke="currentColor"
            fill="currentColor"
            className="size-5 text-[#000c] md:hidden"
          >
            <path
              strokeLinecap="round"
        ...
        <div className="flex justify-between items-center w-3/8 md:w-16 md:hidden">
          <li>
            <svg
              height="48"
              viewBox="0 0 17 48"
