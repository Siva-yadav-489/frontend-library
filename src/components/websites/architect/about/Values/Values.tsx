...
const cards = [
  {
    ...
    description:
      "We believe every space deserves a spark of originality. Bold ideas to unique designs, we do everything",
    image: image,
    icon: svg1,
  },
  {
    ...
    description:
      "Your vision is our blueprint. We listen, collaborate, and turn your ideas into spaces you’ll love.",
    image: image2,
    icon: svg2,
  },
  {
    ...
    description:
      "Your happiness drives our success. We’re here to make your experience as seamless and satisfying as possible.",
    image: image3,
    icon: svg3,
  },
  {
    ...
    description:
      "We’re all about building for the future—eco-friendly materials, smart designs, and a greener tomorrow.",
    image: image4,
    icon: svg4,
  },
  {
    ...
    description:
      "From the grand design to the tiniest features, we obsess over every detail to ensure perfection.",
    image: image5,
    icon: svg5,
  },
  {
    ...
    description:
      "Every project reflects the passion and care we pour into our work. we create outstanding experiences.",
    image: image6,
    icon: svg6,
  },
];
